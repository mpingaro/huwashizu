...
\begin{tikzpicture}
 ...
 {square_example/bolla1_type1/elastic_error_dist_type_1_disp_u_l2_1mu.txt};
 \addlegendentry{$\alpha / \mu=1$}
 %
 \addplot[blue, mark=x, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {square_example/bolla1_type1/elastic_error_dist_type_1_disp_u_l2_2mu.txt};
 \addlegendentry{$\alpha / \mu=2$}
 %
 \addplot[green3, mark=o, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {square_example/bolla1_type1/elastic_error_dist_type_1_disp_u_l2_3mu.txt};
