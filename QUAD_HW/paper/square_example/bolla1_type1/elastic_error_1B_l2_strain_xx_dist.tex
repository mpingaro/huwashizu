...
\begin{tikzpicture}
 ...
 {square_example/bolla1_type1/elastic_error_l2_strain_xx_1B_type1_1mu_dist.txt};
 \addlegendentry{$\alpha / \mu=1$}
 %
 \addplot[blue, mark=x, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {square_example/bolla1_type1/elastic_error_l2_strain_xx_1B_type1_2mu_dist.txt};
 \addlegendentry{$\alpha / \mu=2$}
 %
 \addplot[green3, mark=o, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {square_example/bolla1_type1/elastic_error_l2_strain_xx_1B_type1_3mu_dist.txt};
