...
\end{equation}
%\begin{split}
%&\left. \hspace{24pt} + A\sin\left(\pi x\right)\sin\left(\pi y\right)\right)
%\end{split}
...
%{\input{square_example/bolla1/elastic_error_1B_l2_strain_xx.tex}}
%\subfigure[Case trapezoidal mesh \label{fig:error_strain_xx_l2_1B_type1}]
%{\input{square_example/bolla1/elastic_error_1B_l2_strain_xx_dist.tex}}
%\caption{The relative error of strain $\bm{d}_{xx}$ vs. 
%the number of elements (Case of one bubble function)}
%\end{center}
%\end{figure}
%
