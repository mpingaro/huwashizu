...
\begin{tikzpicture}
 ...
 {quad_cook_membrane_graph/alpha_1/cook_1B_type_1.txt};
 \addlegendentry{1B type 1}
 %
 \addplot[red, mark=+, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {quad_cook_membrane_graph/alpha_1/cook_1B_type_2.txt};
 \addlegendentry{1B type 2}
 %
  \addplot[green3, mark=o, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {quad_cook_membrane_graph/alpha_1/cook_2B.txt};
 \addlegendentry{2B}
 %
 \addplot[blue, mark=x, thick, mark options={solid}]
 table [x index={0}, y index={1}]
 {quad_cook_membrane_graph/alpha_1/cook_2B_mixed.txt};
