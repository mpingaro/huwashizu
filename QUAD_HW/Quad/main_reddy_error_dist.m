...
name =   sprintf('elastic_error_disp_u_l2_%d_dist.txt',cf(k));
%name_1 = sprintf('elastic_error_l2_strain_xx_%dmu_dist.txt',cf(k));
%name_2 = sprintf('elastic_error_l2_strain_yy_%dmu_dist.txt',cf(k));
%name_3 = sprintf('elastic_error_l2_strain_xy_%dmu_dist.txt',cf(k));
