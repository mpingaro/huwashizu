...
% -- B are the tow boubble functions
% ------------------------------------------------------------------------%
...
name =   'elastic_error_disp_u_l2_2B.txt';
name_1 = 'elastic_error_l2_strain_xx_2B.txt';
name_2 = 'elastic_error_l2_strain_yy_2B.txt';
name_3 = 'elastic_error_l2_strain_xy_2B.txt';
