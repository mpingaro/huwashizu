...
name =   'elastic_error_disp_u_l2_2B_mixed.txt';
name_1 = 'elastic_error_l2_strain_xx_2B_mixed.txt';
name_2 = 'elastic_error_l2_strain_yy_2B_mixed.txt';
name_3 = 'elastic_error_l2_strain_xy_2B_mixed.txt';
