...
ndy = 16;                                       % partition in y direction: deve essere pari 
...
%GDL NODI MEZZERIA 
if rem(ndx,2) == 0
    NM1 = NODI1((length(NODI1)+1)/2);
    NM2 = NODI2((length(NODI2)+1)/2);
    NM3 = NODI3((length(NODI3)+1)/2);
    NM4 = NODI4((length(NODI4)+1)/2);
    NM5 = NODI5((length(NODI5)+1)/2);
...
NMX1 = 2*NM1-1;  NMY1 = NMX1 + 1;
NMX2 = 2*NM2-1;  NMY2 = NMX2 + 1;
NMX3 = 2*NM3-1;  NMY3 = NMX3 + 1;
NMX4 = 2*NM4-1;  NMY4 = NMX4 + 1;
NMX5 = 2*NM5-1;  NMY5 = NMX5 + 1;
NMX6 = 2*NM6-1;  NMY6 = NMX6 + 1;
...
FORCEDDOFS = [];
FORCEDDOFS(1,:) = NX4; FORCEDDOFS(2,:) = 0.25;
